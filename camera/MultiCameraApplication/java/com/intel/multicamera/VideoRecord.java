...
public class VideoRecord implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener{
    ...
    public VideoRecord(CameraBase cameraBase, String videoKey, String cameraId, AutoFitTextureView textureView, Activity activity, TextView recordingView, String settingsKey) {
    ...
    private void saveVideo() {
        ...
        ic_camera.setmCurrentFileInfo(mCurrentVideoValues);
