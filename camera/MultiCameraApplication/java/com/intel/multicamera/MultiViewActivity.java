...
public class MultiViewActivity extends AppCompatActivity {
    ...
    public void Open_TopLeftCam() {
        ...
        ic_camera.setmTopLeftCam(new CameraBase(this, mTopLeftCam_textureView, Buttons, mRecordingTimeView,
    ...
    public void Open_TopRightCam() {
        ...
        ic_camera.setmTopRightCam(new CameraBase(this, mTopRightCam_textureView, Buttons, mRecordingTimeView0,
                                      Data, roundedThumbnailView));
    }
    ...
    public void Open_BotmLeftCam() {
        ...
        ic_camera.setmBotmLeftCam(new CameraBase(this, mBotmLeftCam_textureView, Buttons, mRecordingTimeView1,
                                      Data, roundedThumbnailView));
    }
    ...
    private void manageTopLeftCam() {
        ...
        if (mTopLeftCam_textureView.isAvailable()) {
            if (ic_camera.getmTopLeftCam() != null) {
                ic_camera.getmTopLeftCam().textureListener.onSurfaceTextureAvailable(
                        mTopLeftCam_textureView.getSurfaceTexture(), mTopLeftCam_textureView.getWidth(),
                        mTopLeftCam_textureView.getHeight());
            }
        } else {
            if (ic_camera.getmTopLeftCam() != null && mTopLeftCam_textureView != null) {
                mTopLeftCam_textureView.setSurfaceTextureListener(ic_camera.getmTopLeftCam().textureListener);
            }
        }
    ...
    private void manageTopRightCam() {
        frameView1.setVisibility(FrameLayout.VISIBLE);
        FrameVisibility[1] = frameView1.getVisibility();
        if (ic_camera.getmTopRightCam() == null) {
            Open_TopRightCam();
        ...
        if (mTopRightCam_textureView.isAvailable()) {
            ic_camera.getmTopRightCam().textureListener.onSurfaceTextureAvailable(
                    mTopRightCam_textureView.getSurfaceTexture(),
                    mTopRightCam_textureView.getWidth(), mTopRightCam_textureView.getHeight());
        } else {
            mTopRightCam_textureView.setSurfaceTextureListener(ic_camera.getmTopRightCam().textureListener);
        }
    }
    ...
    private void manageBotmLeftCam() {
        ...
        FrameVisibility[2] = frameView2.getVisibility();
        if (ic_camera.getmBotmLeftCam() == null) {
            Open_BotmLeftCam();
        ...
        if (mBotmLeftCam_textureView.isAvailable()) {
            ic_camera.getmBotmLeftCam().textureListener.onSurfaceTextureAvailable(
                    mBotmLeftCam_textureView.getSurfaceTexture(),
                    mBotmLeftCam_textureView.getWidth(), mBotmLeftCam_textureView.getHeight());
        } else {
            mBotmLeftCam_textureView.setSurfaceTextureListener(ic_camera.getmBotmLeftCam().textureListener);
        }
    }
    ...
    private void manageBotmRightCam() {
        ...
        FrameVisibility[3] = frameView3.getVisibility();
        if (ic_camera.getmBotmRightCam() == null) {
            Open_BotmRightCam();
        ...
        if (mBotmRightCam_textureView.isAvailable()) {
            ic_camera.getmBotmRightCam().textureListener.onSurfaceTextureAvailable(
                    mBotmRightCam_textureView.getSurfaceTexture(),
                    mBotmRightCam_textureView.getWidth(), mBotmRightCam_textureView.getHeight());
        } else {
            mBotmRightCam_textureView.setSurfaceTextureListener(ic_camera.getmBotmRightCam().textureListener);
        }
    }
    ...
    public void closeCamera() {
        if (null != ic_camera.getmTopLeftCam()) {
            ic_camera.getmTopLeftCam().closeCamera();
            ic_camera.setmTopLeftCam(null);
        }

        if (null != ic_camera.getmTopRightCam()) {
            ic_camera.getmTopRightCam().closeCamera();
            ic_camera.setmTopRightCam(null);
        }

        if (null != ic_camera.getmBotmRightCam()) {
            ic_camera.getmBotmRightCam().closeCamera();
            ic_camera.setmBotmRightCam(null);
        }

        if (null != ic_camera.getmBotmLeftCam()) {
            ic_camera.getmBotmLeftCam().closeCamera();
            ic_camera.setmBotmLeftCam(null);
        }
    }
    ...
    public void settingClose(View view) {
        ...
        switch (view.getId()) {
            case R.id.mSettingClose0:
                ...
                ic_camera.getmTopLeftCam().createCameraPreview();
            ...
            case R.id.mSettingClose1:
                ...
                ic_camera.getmTopRightCam().createCameraPreview();
            ...
            case R.id.mSettingClose2:
                ...
                ic_camera.getmBotmLeftCam().createCameraPreview();
            ...
            case R.id.mSettingClose3:
                ...
                ic_camera.getmBotmRightCam().createCameraPreview();
