...
public class CameraBase  {
    ...
    public CameraBase(Activity activity, AutoFitTextureView mtextureView, ImageButton[] Button,
        ...
        mRecord = new VideoRecord(this, Video_key,cameraId, mtextureView, mActivity, RecordingTimeView, SettingsKey);

        roundedThumbnailViewControlLayout = mActivity.findViewById(R.id.control1);
        mCameraBase = this;
    }

    private void ClickListeners(ImageButton PictureButton, ImageButton RecordButton, ImageButton Settings, ImageButton CameraSwitch, ImageButton CameraSplit) {
    ...
    private void TakePicureOnClicked(ImageButton PictureButton) {
        ...
        takePictureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ic_camera.getmTopRightCam() != null && ic_camera.getmTopRightCam() == mCameraBase) {
                    ic_camera.setOpenCameraId(1);
                }
                if(ic_camera.getmBotmLeftCam() != null && ic_camera.getmBotmLeftCam() == mCameraBase) {
                    ic_camera.setOpenCameraId(2);
                }
                if(ic_camera.getmTopLeftCam() != null && ic_camera.getmTopLeftCam() == mCameraBase) {
                    ic_camera.setOpenCameraId(0);
                }
                if(ic_camera.getmBotmRightCam() != null && ic_camera.getmBotmRightCam() == mCameraBase) {
    ...
    private void StartVideoRecording(ImageButton RecordButton, final ImageButton Capture, ImageButton Switch, final ImageButton Split, final ImageButton Settings) {
    ...
    private void saveImage(Size imageDimension, File ImageFile) {
        ...
        ic_camera.setmCurrentUri(uri);

        ic_camera.setmCurrentFileInfo(mCurrentPictureValues);
